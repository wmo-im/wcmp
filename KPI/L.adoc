...
* 1..n `gmd:transferOptions` (`//gmd:MD_Metadata/gmd:distributionInfo/*/gmd:transferOptions//gmd:onLine`),
...
! a valid linkage is provided
! 1

!===
|1 foreach transfer option

|===

Total possible score: 4 per transfer option + 4 for format/distributor (100%).
For transfer options, assess how many transfer options are defined and provide
a total percentage based on the number of transfer options and individual
scoring.
