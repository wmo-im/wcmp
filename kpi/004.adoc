...
The TemporalExtent is included in `gmd:temporalElement`:
...
The Data Update Frequency is included in `gmd:maintenanceAndUpdateFrequency`:
...
|The Temporal Extent is included
|1
...
|The Data Update Frequency is included
|1

|The Data Status is included
|1
|===
...
Ensure that the Temporal Extent and the Update Frequency is included in the metadata record.
