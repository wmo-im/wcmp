...
Products that qualify as WMOEssential should be available with "free and unrestricted international exchange", and therefore, should have 1 to many distribution links present in the metadata.
