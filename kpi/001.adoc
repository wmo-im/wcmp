== KPI-{counter:kpi}: WCMP 1.3, Part 2 Compliance
...
All WCMP elements specified in link:https://wis.wmo.int/2013/metadata/version_1-3-0/WMO_Core_Metadata_Profile_v1.3_Part_2.pdf[WCMP 1.3, Part 2 – Abstract Test Suite, Data Dictionary and Code Lists].
